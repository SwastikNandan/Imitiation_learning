...
void callback(const ImageConstPtr& original_image, const velocityConstPtr& vel)
{
    ...
    if (velocity == "0"){
        path = "/home/swastik/iml_proj/learning/depth/images/stay/";
    } else if (velocity == "0.5"){
        path = "/home/swastik/iml_proj/learning/depth/images/up/";
    } else if (velocity == "-0.5"){
        path = "/home/swastik/iml_proj/learning/depth/images/down/";
    }
